...
In order to find the minimal value of $\Sigma_x$, we can search for the zeros of the derivate of the convexe function $\Sigma_x \mapsto p_{\Theta}(X_{1:T}, y_{1:T}, u_{1:T})$.
